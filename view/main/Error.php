<aside id="mdc-dialog-with-list" class="mdc-dialog mdc-dialog--open" role="alertdialog"
	...
	<div class="mdc-dialog__surface" data-vivaldi-spatnav-clickable="1">
		<header class="mdc-dialog__header"><h2 id="mdc-dialog-with-list-label" class="mdc-dialog__header__title">404</h2></header>
		<section id="mdc-dialog-with-list-description" class="mdc-dialog__body mdc-dialog__body">Ooops ! Your page was not found, maybe you've entered a wrong URL, try again!</section>
